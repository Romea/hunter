...
def launch_setup(context, *args, **kwargs):
    ...
    if mode == "simulation":
        ...
        robot_description_file = "/tmp/hunter_description.urdf"
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                [
                    PathJoinSubstitution(
                        [
                            FindPackageShare("hunter_bringup"),
                            "launch",
    ...
    teleop_configuration_file_path = (
        get_package_share_directory("hunter_description") + "/config/teleop.yaml"
    )
    ...
    robot.append(
        GroupAction(
            actions=[
                ...
                IncludeLaunchDescription(
                    PythonLaunchDescriptionSource(
                        get_package_share_directory("hunter_bringup")
                        + "/launch/hunter_teleop.launch.py"
                    ),
                    launch_arguments={
                        "joystick_type": joystick_type,
                        "joystick_driver": "joy",
                        "joystick_topic": "/hunter/joystick/joy",
...
def generate_launch_description():
    ...
    robot_urdf_description = Command(
        [
            ExecutableInPackage("urdf_description.py", "hunter_bringup"),
